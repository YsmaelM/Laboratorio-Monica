...
export function ReportFooter({ footerText }: ReportFooterProps) {
  return (
    <View>
      <View style={{ flex: 1 }}>
      ...
      <View style={{ flexDirection: "row", gap: 30 }}>
        {/* Signatures block placeholder */}
        <View style={{ alignItems: "center" }}>
          <View style={{ width: 120, borderBottomWidth: 1, borderBottomColor: "#334155", marginBottom: 4 }} />
